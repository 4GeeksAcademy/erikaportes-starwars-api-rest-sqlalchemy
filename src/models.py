...
from sqlalchemy import String, Text, Boolean, ForeignKey, DateTime, CheckConstraint, UniqueConstraint
...
class Character(db.Model):
    ...
    birth_year: Mapped[str | None] = mapped_column(String(50), nullable=True)
